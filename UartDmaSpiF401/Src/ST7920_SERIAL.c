 ...
 * B0 ---------> RST (RST)
 *
 * LED_RES_Pin|LED_MOSI_RW_Pin|LED_CSK_E_Pin|LED_CS_Pin, GPIO_PIN_RESET)
 */

#define SCLK_PIN LED_CSK_E_Pin
#define SCLK_PORT LED_CSK_E_GPIO_Port
#define CS_PIN LED_CS_Pin
#define CS_PORT LED_CS_GPIO_Port
#define SID_PIN LED_MOSI_RW_Pin
#define SID_PORT LED_MOSI_RW_GPIO_Port
#define RST_PIN LED_RST_Pin
#define RST_PORT LED_RST_GPIO_Port
